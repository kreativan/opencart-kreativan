...
class ModelToolKreativanResize extends Model {
  ...
  public function width($filename, $width) {
    ...
    $image_old = $filename;
    $image_new = 'cache/' . utf8_substr($filename, 0, utf8_strrpos($filename, '.')) . '-w' . (int)$width . '.' . $extension;
  ...
  public function height($filename, $height) {
    ...
    $image_old = $filename;
    $image_new = 'cache/' . utf8_substr($filename, 0, utf8_strrpos($filename, '.')) . '-h' . (int)$height . '.' . $extension;
